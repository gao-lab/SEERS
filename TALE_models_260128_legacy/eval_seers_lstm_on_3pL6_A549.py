...
# -------------------------
# Dataset utilities matching the training format.
# -------------------------
...
# -------------------------
# Minimal model definition matching the training architecture.
# -------------------------
...
def main():
    ...
    if not rows:
        raise RuntimeError("No models evaluated. Check models_root and file names.")
