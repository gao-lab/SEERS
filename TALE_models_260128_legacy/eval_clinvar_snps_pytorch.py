...
# -------------------------
# Tokenization matching the Keras vocabulary.
# vocab = ['pad','N','A','T','C','G']
# -------------------------
VOCAB = ["pad", "N", "A", "T", "C", "G"]
...
def vectorize_dna_seq(dna_seq: str) -> List[int]:
    # Match the Keras token mapping; map unknown bases to 'N'.
...
# -------------------------
# Model definition. Adjust if using a checkpoint with a different architecture.
# -------------------------
class SEERSLSTM2Head(nn.Module):
    ...
    IMPORTANT: this architecture must match the saved .pth checkpoint.
    """
